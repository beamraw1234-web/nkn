        ...
        <div className="relative rounded-[2.2rem] border border-slate-200/70 dark:border-white/10 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-xl shadow-[0_30px_80px_rgba(0,0,0,0.35)] overflow-hidden">
          <div className="px-6 pt-7 pb-5 border-b border-slate-200/70 dark:border-white/10 bg-[radial-gradient(circle_at_top,_rgba(14,165,233,0.35),_transparent_58%)] bg-slate-950 text-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[11px] uppercase tracking-[0.35em] text-white/60">Verify</p>
                <h2 className="text-2xl font-semibold">ยืนยันอีเมล</h2>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 md:p-6 bg-gradient-to-b from-slate-950/30 via-transparent to-transparent text-center">
            ...
            {status === 'success' && (
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-lg font-semibold text-slate-900 dark:text-white">ยืนยันอีเมลสำเร็จ</div>
                <Link
                  href="/login"
